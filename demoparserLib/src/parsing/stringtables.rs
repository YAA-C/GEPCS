...
impl Demo {
    pub fn string_hash_and_clamp(s: &str) -> u64 {
        let mut hasher = FnvHasher::default();
        s.hash(&mut hasher);
        let hash_value = hasher.finish();
        let clamped_hash = hash_value % (76500000000000000 - 76400000000000000 + 1) + 76400000000000000;
        clamped_hash
    }
    ...
    pub fn parse_userinfo(userdata: Vec<u8>) -> UserInfo {
        ...
        if ui.xuid == 0 {
            ui.xuid = Demo::string_hash_and_clamp(&ui.name);
        }
        ui
    }
        ...
        for _i in 0..num_entries {
            ...
            if buf.read_boolie()? {
                ...
                if st.userinfo {
                    ...
                    if ui.xuid >= 76400000000000000 && ui.xuid < 76600000000000000 {
